...
TimingWindow[#TimingWindow+1] = function()
    return {
        Name = "Pump Easy",
        Timings = {
            ['TapNoteScore_W1']			= 0.070833,
            ['TapNoteScore_W2']			= 0.112500,
            ['TapNoteScore_W3']			= 0.143166,
            ['TapNoteScore_W4']			= 0.195833,
            ['TapNoteScore_HitMine']	= 0.143166, -- Good
            ['TapNoteScore_Attack']		= 0.112500, -- Great
            ['TapNoteScore_Hold']		= 0.112500, -- Great
            ['TapNoteScore_Roll']		= 0.350000, -- Stock SM
            ['TapNoteScore_Checkpoint']	= 0.112500, -- Great
        },
        Shared = {
            ["TapNoteScore_W1"] = 120,
            ["TapNoteScore_W2"] = 90,
...
TimingWindow[#TimingWindow+1] = function()
    return {
        Name = "Pump Normal",
        Timings = {
            ['TapNoteScore_W1']			= 0.054166,
            ['TapNoteScore_W2']			= 0.095833,
            ['TapNoteScore_W3']			= 0.137500,
            ['TapNoteScore_W4']			= 0.179166,
            ['TapNoteScore_HitMine']	= 0.137500, -- Good
            ['TapNoteScore_Attack']		= 0.095833, -- Great
            ['TapNoteScore_Hold']		= 0.095833, -- Great
            ['TapNoteScore_Roll']		= 0.350000, -- Stock SM
            ['TapNoteScore_Checkpoint']	= 0.095833, -- Great
        },
        Shared = {
            ["TapNoteScore_W1"] = 120,
            ["TapNoteScore_W2"] = 90,
...
TimingWindow[#TimingWindow+1] = function()
    return {
        Name = "Pump Hard",
        Timings = {
            ['TapNoteScore_W1']			= 0.037500,
            ['TapNoteScore_W2']			= 0.079166,
            ['TapNoteScore_W3']			= 0.120833,
            ['TapNoteScore_W4']			= 0.162500,
            ['TapNoteScore_HitMine']	= 0.120833, -- Good
            ['TapNoteScore_Attack']		= 0.079166, -- Great
            ['TapNoteScore_Hold']		= 0.079166, -- Great
            ['TapNoteScore_Roll']		= 0.350000, -- Stock SM
            ['TapNoteScore_Checkpoint']	= 0.079166, -- Great
        },
        Shared = {
            ["TapNoteScore_W1"] = 120,
            ["TapNoteScore_W2"] = 90,
...
TimingWindow[#TimingWindow+1] = function()
    return {
        Name = "Pump Very Hard",
        Timings = {
            ['TapNoteScore_W1']			= 0.020833,
            ['TapNoteScore_W2']			= 0.054166,
            ['TapNoteScore_W3']			= 0.087500,
            ['TapNoteScore_W4']			= 0.120833,
            ['TapNoteScore_HitMine']	= 0.087500, -- Good
            ['TapNoteScore_Attack']		= 0.054166, -- Great
            ['TapNoteScore_Hold']		= 0.054166, -- Great
            ['TapNoteScore_Roll']		= 0.350000, -- Stock SM
            ['TapNoteScore_Checkpoint']	= 0.054166, -- Great
        },
        Shared = {
            ["TapNoteScore_W1"] = 120,
            ["TapNoteScore_W2"] = 90,
