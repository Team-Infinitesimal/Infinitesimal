...
* Switching timing modes does not update the list of judgement graphics, simply reloading the cnrrent screen or changing screens will regenerate the list
