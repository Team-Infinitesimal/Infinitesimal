...
t[#t+1] = LoadActor(THEME:GetPathG("", "BlankScreenHudFrame"))
...
t[#t+1] = Def.ActorFrame{
    ...
    Def.Sprite {
        ...
        InitCommand=function(s)
          s:Load( img_cache[curitem][2] )
          :x(SCREEN_CENTER_X - 138)
          :y(SCREEN_BOTTOM + 80)
          :MaskDest();
        end;

        SetTheSizeProperlyCommand=function(self)
        ...
        ChangeItemsMessageCommand=function(self)
          self:queuecommand("SetTheSizeProperly")
        end;
    },
    ...
    Def.BitmapText{
        ...
        InitCommand=function(s) s:zoom(0.5):settext(string.gsub( img_cache[curitem][1], ".(^)", "" ) ) end,
        OnCommand=function(s) s:xy( SCREEN_LEFT + 50, SCREEN_BOTTOM - 37 ):halign(0):vertalign(top) end,
    }
}
