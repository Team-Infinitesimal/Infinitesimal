local t = Def.ActorFrame {
    ...
    Def.BitmapText{
    	...
    	InitCommand=function(self)
    		self:x(SCREEN_CENTER_X - (GetScreenAspectRatio() >= 1.5 and (GetScreenAspectRatio() * 103) + 67 or 170))
    		:zoom(0.4)
    ...
    Def.BitmapText{
    	...
    	Text="PROFILE",
    	InitCommand=function(self)
    		self:x(SCREEN_CENTER_X - (GetScreenAspectRatio() >= 1.5 and (GetScreenAspectRatio() * 103) or 170))
    		:zoom(0.4)
    		:shadowcolor(0,0,0,0.25)
    		:shadowlength(0.75)
    		:diffuse(0,0,0,1)
